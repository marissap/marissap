...
- and built an agent that creates personalized sales scenarios for people based on their current scorecard for aws way of selling so they can get better. i originally wrote this in python and then i realized i hate flask so i changed it into a react app and wrote it in typescript and yeah, uses bedrock, RAG.
